...
public class UserController {
    ...
    //User Login
    @PostMapping("/login")
    public ResponseEntity<String> userLoginControHandler(@Valid @RequestBody UserDTO userDTO){
    ...
    public ResponseEntity<User> updateUserCredsHandler(@Valid @RequestBody User user, @PathVariable String key){
    ...
    public ResponseEntity<String> userLogoutHandler(@Valid @PathVariable String key){
